namespace ADProject_Team10.Models
{
    ...
    public partial class StoreEntities : DbContext
    {
        ...
        public virtual DbSet<Stock_Adjustment_Voucher> Stock_Adjustment_Vouchers { get; set; }
        public virtual DbSet<Stock_Adjustment_Voucher_Detail> Stock_Adjustment_Voucher_Details { get; set; }
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Employee>()
                .HasMany(e => e.Stock_Adjustment_Voucher)
                .WithRequired(e => e.Employee)
                .HasForeignKey(e => e.ClerkEmployeeId)
                .WillCascadeOnDelete(false);

            modelBuilder.Entity<Employee>()
                .HasMany(e => e.Stock_Adjustment_Voucher1)
                .WithRequired(e => e.Employee1)
                .HasForeignKey(e => e.SupervisorEmployeeId)
                .WillCascadeOnDelete(false);

            modelBuilder.Entity<Order>()
                .HasOptional(e => e.Order1)
            ...
            modelBuilder.Entity<Stationery>()
                .HasMany(e => e.Stock_Adjustment_Voucher_Details)
                .WithRequired(e => e.Stationery)
                .WillCascadeOnDelete(false);
            ...
            modelBuilder.Entity<Stock_Adjustment_Voucher>()
                .HasMany(e => e.Stock_Adjustment_Voucher_Details)
                .WithRequired(e => e.Stock_Adjustment_Voucher)
                .WillCascadeOnDelete(false);
